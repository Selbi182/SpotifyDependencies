package de.selbi.spotify.config;
...
public class Config {
  ...
  public static class SpotifyBotConfig {
    ...
    public String toString() {
      return "SpotifyBotConfig [clientId=" + clientId + ", clientSecret=" + clientSecret + ", accessToken=" + accessToken
          + ", refreshToken=" + refreshToken + ", market=" + market + "]";
    }
